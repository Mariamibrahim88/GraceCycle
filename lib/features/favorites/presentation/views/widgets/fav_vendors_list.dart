...
import 'package:grace_cycle/features/favorites/presentation/views/widgets/empty_fav_widget.dart';
        ...
        builder: (context, state) {
          if (state is GetFavVendorsLoading) {
            ...
            if (state.favVendorModel.isEmpty) {
              return const EmptyFavWidget(title: 'No favorite vendors yet!');
            }
