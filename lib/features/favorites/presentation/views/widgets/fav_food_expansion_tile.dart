...
class FavFoodExpansionTile extends StatelessWidget {
  const FavFoodExpansionTile({super.key});
...
class FavPriceExpansionTile extends StatelessWidget {
  const FavPriceExpansionTile({super.key});
